...
import RealtyItem from "./NavBarItems/RealtyItem";
import RealtyImage from "../icons/RealtyImage.png";
...
const array_01 = [];
for (let i = 0; i < 10; i++) {
    array_01.push(<RealtyItem article={sampleArticle2}/>);
};
const array_02 = [];
for (let i = 0; i < 10; i++) {
    array_02.push(<RealtyItem article={sampleArticle2}/>);
};
    ...
    return (
            <RealtyListWrap>
                <section className="nearbystore-article-list">
                    <h1 className="article-list-title">인기 부동산 직거래 게시글</h1>
...
const RealtyListWrap = styled.div`
    ...
    .business-profile-image_01 {
        background-image: url(${RealtyImage});
