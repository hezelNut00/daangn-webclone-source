...
const RealtyItem = ({ article }) => {
    const { url, urlToImage, name, region, salary, price } = article;
        ...
        <RealtyItemWrap>
            ...
            <div className='contents'>
                <a href={url} target='_blank' rel='noopener noreferrer'>
                    ...
                    <div className="nbs-list-item-desc">{salary} {numberToKorean(price)}</div>
                </a>
            </div>
        </RealtyItemWrap>
    );
...
const RealtyItemWrap = styled.div`
    width: 336px;
    height: 100px;
    align-items: center;
    padding: 16px;
